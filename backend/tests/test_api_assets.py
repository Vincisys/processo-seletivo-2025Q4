...
class TestAssetRoutes:
    ...
    def test_create_asset_success(self, client, created_owner, sample_asset_data):
    ...
    def test_create_asset_owner_not_found(self, client, sample_asset_data):
    ...
    def test_create_asset_missing_field(self, client, created_owner):
    ...
    def test_create_asset_name_too_long(self, client, created_owner):
    ...
    def test_get_asset_success(self, client, created_asset):
        """Testa busca bem-sucedida de asset por ID"""
        response = client.get(f"/integrations/asset/{created_asset['id']}")
    ...
    def test_get_asset_not_found(self, client):
        ...
        response = client.get(f"/integrations/asset/{fake_id}")
    ...
    def test_list_assets_empty(self, client):
        ...
        response = client.get("/integrations/assets")
        
        assert response.status_code == 200
        assert response.json() == []
    
    def test_list_assets_with_data(self, client, created_asset):
    ...
    def test_list_assets_pagination(self, client, created_owner, sample_asset_data):
        ...
        for i in range(5):
            ...
            client.post("/integrations/asset", json=data)
        
        # Primeira página
        response = client.get("/integrations/assets?skip=0&limit=2")
        assert response.status_code == 200
        assert len(response.json()) == 2
        
        # Segunda página
        response = client.get("/integrations/assets?skip=2&limit=2")
        assert response.status_code == 200
        assert len(response.json()) == 2
    
    def test_update_asset_success(self, client, created_asset):
    ...
    def test_update_asset_not_found(self, client):
        ...
        fake_id = "00000000-0000-0000-0000-000000000000"
        update_data = {"name": "Aeronave Boeing 777"}
        response = client.put(f"/integrations/asset/{fake_id}", json=update_data)
        
        assert response.status_code == 404
    
    def test_update_asset_owner_not_found(self, client, created_asset):
    ...
    def test_update_asset_name_too_long(self, client, created_asset):
    ...
    def test_delete_asset_success(self, client, created_asset):
        """Testa deleção bem-sucedida de asset"""
        response = client.delete(f"/integrations/asset/{created_asset['id']}")
    ...
    def test_delete_asset_not_found(self, client):
        ...
        fake_id = "00000000-0000-0000-0000-000000000000"
        response = client.delete(f"/integrations/asset/{fake_id}")
        
        assert response.status_code == 404
    
    def test_asset_owner_relationship(self, client, created_owner, sample_asset_data):
        ...
        response = client.get(f"/integrations/owner/{asset['owner']}")
        assert response.status_code == 200
        owner = response.json()
