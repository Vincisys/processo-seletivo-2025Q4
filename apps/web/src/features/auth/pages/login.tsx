    ...
    <div className="grid min-h-screen w-full lg:grid-cols-2">
      <div className="flex flex-col gap-4 p-6 md:p-10">
        <div className="flex justify-center gap-2 md:justify-start items-center">
          ...
          <span className="text-xl font-bold text-foreground tracking-tight">eyesonasset</span>
        </div>
      ...
      <div className="relative hidden bg-orange-50 lg:block">
        <div className="absolute inset-0 bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center p-12">
           <div className="text-white max-w-lg text-center space-y-6">
               <h2 className="text-3xl md:text-4xl font-bold">Controle Total dos Seus Ativos</h2>
               <p className="text-lg text-orange-50">
                 Gerencie, monitore e otimize seus recursos com a plataforma EyesOnAsset.
                 Simplicidade e eficiência em um só lugar.
               </p>
           </div>
